...
For services in nested namespaces, represent each namespace segment as a nested
object. For example, `Contoso.Messaging.ServiceA` can be configured as follows:
