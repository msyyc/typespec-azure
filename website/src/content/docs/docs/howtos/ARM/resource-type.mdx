...
prepaid billing, where a customer is charged before the product is provisioned or fulfilled.

Unlike ARM envelope properties, `BillingDataProperty` belongs in the resource-specific property bag:
